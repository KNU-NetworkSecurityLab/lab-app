...
class RepoCardAdapter (val context: Context, private val repoItem : ArrayList<RepoCardItem>) :
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        holder.run {
            ...
            var tags = ""
            for(i in repoItem[position].langTag) { tags += "$i |" }
    ...
    inner class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var tv_item_repo_description = itemView.findViewById<TextView>(R.id.tv_item_repo_description)
    }
}